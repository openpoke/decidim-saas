...
module Decidim::Debates::ContentBlocks
  describe HighlightedDebatesCell, type: :cell do
    ...
    context "with 4 debates (4 open, 1 closed)" do
      ...
      it "renders only 3 most recent open debates" do
        ...
        expect(subject).to have_css(".card__grid", count: 4)
        ...
        expect(subject).to have_content("Old Debate")
      end
    end
