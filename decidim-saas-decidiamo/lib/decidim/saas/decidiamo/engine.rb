  ...
  module Saas
    module Decidiamo
      class Engine < ::Rails::Engine
        isolate_namespace Decidim::Saas::Decidiamo

        paths["db/migrate"] = nil
        paths["lib/tasks"] = nil

        initializer "saas.decidiamo.extra_user_fields" do
        ...
        config.to_prepare do
          ...
          Decidim::ApplicationController.class_eval do
            include Decidim::Saas::Decidiamo::NeedsSurveyCompleted
          end
        ...
        initializer "saas.decidiamo.static_files" do |app|
          app.middleware.use ActionDispatch::Static, "#{root}/public"
        end

        initializer "saas.decidiamo.cell_views" do
          Cell::ViewModel.view_paths.unshift File.expand_path("#{root}/app/cells")
        end

        initializer "saas.decidiamo.hero_content_block_settings", after: "decidim.core.content_blocks" do
