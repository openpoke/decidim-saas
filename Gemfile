...
DECIDIM_VERSION = { github: "openpoke/decidim", branch: "backport/posts-taxonomies" }.freeze
...
gem "decidim-decidim_awesome", github: "decidim-ice/decidim-module-decidim_awesome", branch: "awesome-verifications"
